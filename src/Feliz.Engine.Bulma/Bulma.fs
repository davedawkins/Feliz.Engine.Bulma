...
type TitleEngine<'Element>( h : Feliz.HtmlEngine<'Element>, a : Feliz.AttrEngine<'Element> ) =
    ...
    member _.h1Is1 (value: string) = Helpers.MakeNode(h,a, "h1", "is-1", Helpers.ToElems(h,value))
    member _.h1Is1 (value: int) = Helpers.MakeNode(h,a, "h1", "is-1", Helpers.ToElems(h,value))
    member _.h1Is1 (value: float) = Helpers.MakeNode(h,a, "h1", "is-1", Helpers.ToElems(h,value))
    member _.h1Is1 (value: 'Element) = Helpers.MakeNode(h,a, "h1", "is-1", Helpers.ToElems(h,value))
    member _.h1Is1 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h1", "is-1", Helpers.ToElems(h,children))
    member _.h2Is2 (value: string) = Helpers.MakeNode(h,a, "h2", "is-2", Helpers.ToElems(h,value))
    member _.h2Is2 (value: int) = Helpers.MakeNode(h,a, "h2", "is-2", Helpers.ToElems(h,value))
    member _.h2Is2 (value: float) = Helpers.MakeNode(h,a, "h2", "is-2", Helpers.ToElems(h,value))
    member _.h2Is2 (value: 'Element) = Helpers.MakeNode(h,a, "h2", "is-2", Helpers.ToElems(h,value))
    member _.h2Is2 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h2", "is-2", Helpers.ToElems(h,children))
    member _.h3Is3 (value: string) = Helpers.MakeNode(h,a, "h3", "is-3", Helpers.ToElems(h,value))
    member _.h3Is3 (value: int) = Helpers.MakeNode(h,a, "h3", "is-3", Helpers.ToElems(h,value))
    member _.h3Is3 (value: float) = Helpers.MakeNode(h,a, "h3", "is-3", Helpers.ToElems(h,value))
    member _.h3Is3 (value: 'Element) = Helpers.MakeNode(h,a, "h3", "is-3", Helpers.ToElems(h,value))
    member _.h3Is3 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h3", "is-3", Helpers.ToElems(h,children))
    member _.h4Is4 (value: string) = Helpers.MakeNode(h,a, "h4", "is-4", Helpers.ToElems(h,value))
    member _.h4Is4 (value: int) = Helpers.MakeNode(h,a, "h4", "is-4", Helpers.ToElems(h,value))
    member _.h4Is4 (value: float) = Helpers.MakeNode(h,a, "h4", "is-4", Helpers.ToElems(h,value))
    member _.h4Is4 (value: 'Element) = Helpers.MakeNode(h,a, "h4", "is-4", Helpers.ToElems(h,value))
    member _.h4Is4 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h4", "is-4", Helpers.ToElems(h,children))
    member _.h5Is5 (value: string) = Helpers.MakeNode(h,a, "h5", "is-5", Helpers.ToElems(h,value))
    member _.h5Is5 (value: int) = Helpers.MakeNode(h,a, "h5", "is-5", Helpers.ToElems(h,value))
    member _.h5Is5 (value: float) = Helpers.MakeNode(h,a, "h5", "is-5", Helpers.ToElems(h,value))
    member _.h5Is5 (value: 'Element) = Helpers.MakeNode(h,a, "h5", "is-5", Helpers.ToElems(h,value))
    member _.h5Is5 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h5", "is-5", Helpers.ToElems(h,children))
    member _.h6Is6 (value: string) = Helpers.MakeNode(h,a, "h6", "is-6", Helpers.ToElems(h,value))
    member _.h6Is6 (value: int) = Helpers.MakeNode(h,a, "h6", "is-6", Helpers.ToElems(h,value))
    member _.h6Is6 (value: float) = Helpers.MakeNode(h,a, "h6", "is-6", Helpers.ToElems(h,value))
    member _.h6Is6 (value: 'Element) = Helpers.MakeNode(h,a, "h6", "is-6", Helpers.ToElems(h,value))
    member _.h6Is6 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h6", "is-6", Helpers.ToElems(h,children))
...
type BulmaEngine<'Element>( h : HtmlEngine<'Element>, a : AttrEngine<'Element> ) =
    ...
    member _.fileInput (value: string) = Helpers.MakeNode(h,a, "input", "", [a.type' "file"] @ Helpers.ToElems(h,value))
    member _.fileInput (value: int) = Helpers.MakeNode(h,a, "input", "", [a.type' "file"] @ Helpers.ToElems(h,value))
    member _.fileInput (value: float) = Helpers.MakeNode(h,a, "input", "", [a.type' "file"] @ Helpers.ToElems(h,value))
    member _.fileInput (value: 'Element) = Helpers.MakeNode(h,a, "input", "", [a.type' "file"] @ Helpers.ToElems(h,value))
    member _.fileInput (children: seq<'Element>) = Helpers.MakeNode(h,a, "input", "", [a.type' "file"] @ Helpers.ToElems(h,children))
