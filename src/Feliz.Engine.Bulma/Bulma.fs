...
type TitleEngine<'Element>( h : Feliz.HtmlEngine<'Element>, a : Feliz.AttrEngine<'Element> ) =
    member _.h1 (value: string) = Helpers.MakeNode(h,a, "h1", "is-1", Helpers.ToElems(h,value))
    member _.h1 (value: int) = Helpers.MakeNode(h,a, "h1", "is-1", Helpers.ToElems(h,value))
    member _.h1 (value: float) = Helpers.MakeNode(h,a, "h1", "is-1", Helpers.ToElems(h,value))
    member _.h1 (value: 'Element) = Helpers.MakeNode(h,a, "h1", "is-1", Helpers.ToElems(h,value))
    member _.h1 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h1", "is-1", Helpers.ToElems(h,children))
    member _.h2 (value: string) = Helpers.MakeNode(h,a, "h2", "is-2", Helpers.ToElems(h,value))
    member _.h2 (value: int) = Helpers.MakeNode(h,a, "h2", "is-2", Helpers.ToElems(h,value))
    member _.h2 (value: float) = Helpers.MakeNode(h,a, "h2", "is-2", Helpers.ToElems(h,value))
    member _.h2 (value: 'Element) = Helpers.MakeNode(h,a, "h2", "is-2", Helpers.ToElems(h,value))
    member _.h2 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h2", "is-2", Helpers.ToElems(h,children))
    member _.h3 (value: string) = Helpers.MakeNode(h,a, "h3", "is-3", Helpers.ToElems(h,value))
    member _.h3 (value: int) = Helpers.MakeNode(h,a, "h3", "is-3", Helpers.ToElems(h,value))
    member _.h3 (value: float) = Helpers.MakeNode(h,a, "h3", "is-3", Helpers.ToElems(h,value))
    member _.h3 (value: 'Element) = Helpers.MakeNode(h,a, "h3", "is-3", Helpers.ToElems(h,value))
    member _.h3 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h3", "is-3", Helpers.ToElems(h,children))
    member _.h4 (value: string) = Helpers.MakeNode(h,a, "h4", "is-4", Helpers.ToElems(h,value))
    member _.h4 (value: int) = Helpers.MakeNode(h,a, "h4", "is-4", Helpers.ToElems(h,value))
    member _.h4 (value: float) = Helpers.MakeNode(h,a, "h4", "is-4", Helpers.ToElems(h,value))
    member _.h4 (value: 'Element) = Helpers.MakeNode(h,a, "h4", "is-4", Helpers.ToElems(h,value))
    member _.h4 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h4", "is-4", Helpers.ToElems(h,children))
    member _.h5 (value: string) = Helpers.MakeNode(h,a, "h5", "is-5", Helpers.ToElems(h,value))
    member _.h5 (value: int) = Helpers.MakeNode(h,a, "h5", "is-5", Helpers.ToElems(h,value))
    member _.h5 (value: float) = Helpers.MakeNode(h,a, "h5", "is-5", Helpers.ToElems(h,value))
    member _.h5 (value: 'Element) = Helpers.MakeNode(h,a, "h5", "is-5", Helpers.ToElems(h,value))
    member _.h5 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h5", "is-5", Helpers.ToElems(h,children))
    member _.h6 (value: string) = Helpers.MakeNode(h,a, "h6", "is-6", Helpers.ToElems(h,value))
    member _.h6 (value: int) = Helpers.MakeNode(h,a, "h6", "is-6", Helpers.ToElems(h,value))
    member _.h6 (value: float) = Helpers.MakeNode(h,a, "h6", "is-6", Helpers.ToElems(h,value))
    member _.h6 (value: 'Element) = Helpers.MakeNode(h,a, "h6", "is-6", Helpers.ToElems(h,value))
    member _.h6 (children: seq<'Element>) = Helpers.MakeNode(h,a, "h6", "is-6", Helpers.ToElems(h,children))
